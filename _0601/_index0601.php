...
<head>
	...
	<link rel="stylesheet" href="css/index0601.css">
	<script>
...
<script>
	$(".popup").click(function () {
		...
		//console.log(order);
		if (order == 'youtube_1') {
			video = '<iframe class="embed-responsive-item" width="560" height="315" frameborder="0" allowfullscreen src="https://www.youtube.com/embed/bwRzv8LU66s?autoplay=1&playlist=bwRzv8LU66s&loop=1" ></iframe>';
		}else if (order == 'youtube_2') {
			video = '<iframe class="embed-responsive-item" width="560" height="315" frameborder="0" allowfullscreen src="https://www.youtube.com/embed/NRaIKd9OXN0?autoplay=1&playlist=NRaIKd9OXN0&loop=1" ></iframe>';
		}else if (order == 'youtube_3'){
			video = '<iframe class="embed-responsive-item" width="560" height="315" frameborder="0" allowfullscreen src="https://www.youtube.com/embed/JjYZ-wOTIjc?autoplay=1&playlist=JjYZ-wOTIjc&loop=1" ></iframe>';
		}else {
			video = '';
		}

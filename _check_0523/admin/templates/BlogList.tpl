                ...
                <form name="ListForm" id="ListForm" method="post" action="{$_FileName}?flag=delete" >
                	<div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                            ...
                            <tr>
                                <td><input type="checkbox" name="ids[]" value="{$obj.blog_id}" /></td>
                                <!--<td>
                                    {$_NewsType[$obj.blog_type]}
                                </td>-->
                                <td>
                                    {$obj.blog_title}
                                </td>
                                ...
                                <td>
                                    <a href="{$_FileName}?flag=edit&id={$obj.blog_id}" title="修改"><i class="fa fa-pencil"></i></a>
                                    <a href="javascript:void(0)" onclick="if(confirm('確認刪除?'))location.href='{$FileName}?flag=delete&ids={$obj.blog_id}'" title="刪除"><i class="fa fa-trash-o"></i></a> 
                                </td>
                            </tr>
                           {/foreach}
                        </table>

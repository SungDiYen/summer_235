          	  ...
          	  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                          <div class="form-group">
                            <label>發佈日期</label>
                            <input type="text" name="news_date" id="news_date" value="{$Data.news_date}" class="form-control date_pick"/>
                          </div>
                          <div class="form-group">
                            <label>標題</label>
                            <input type="text" name="news_title" id="news_title" value="{$Data.news_title}" class="form-control "/>
                          </div>
                          <div class="form-group">
                            <label>圖片上傳</label>
                            {if $Data.news_pic!=""}
                            <a href="{$uploadUrl}{$Data.news_pic}" target="_blank">
                                <img src="{$uploadUrl}{$Data.news_pic}" width="150" ></img>
                            </a>
                            {/if}
                            <input type="file" name="news_pic" id="news_pic">
                            {if $Data.news_pic!=""}
                            <input type="checkbox" name="pic_Del" value="*" />刪除
                            <input type="hidden" name="opic" value="{$Data.news_pic}" />
                            {/if}
                            <br>
                          ...
                          <!--<div class="form-group">
                            <label>引文</label>
                            <textarea name="news_quotation" id="news_quotation" class="form-control ">{$Data.news_quotation}</textarea>
                          </div>-->
                          <div class="form-group">
                            <label>內容</label>
                            {$FCK_content}
                          ...
                          <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="show_mode" id="show_mode1" value="Y" {if $Data.show_status=="Y" || $Data.news_id==""}checked{/if} >是
                            </label>
                            <label class="radio-inline">

<?php /* Smarty version Smarty3-RC3, created on 2014-10-05 15:12:19
         compiled from "C:/xampp/htdocs/psoator/admin/\templates\MoodEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:36405430ef538e8026-07253207%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '86670c657c6c4e983ff0bef66699d2786a7c6c7d' => 
    array (
      0 => 'C:/xampp/htdocs/psoator/admin/\\templates\\MoodEdit.tpl',
      1 => 1412493133,
    ),
  ),
  'nocache_hash' => '36405430ef538e8026-07253207',
  'function' => 
  array (
  ),
          	  ...
          	  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                          <div class="form-group">
                            <label>發佈日期</label>
                            <input type="text" name="mood_date" id="mood_date" value="<?php echo $_smarty_tpl->getVariable('Data')->value['mood_date'];?>
" class="form-control date_pick"/>
                          </div>
                          
                          <div class="form-group">
                            <label>標題</label>
                            <input type="text" name="mood_title" id="mood_title" value="<?php echo $_smarty_tpl->getVariable('Data')->value['mood_title'];?>
" class="form-control "/>
                          </div>
                          <div class="form-group">
                            <label>圖片上傳</label>
                            <?php if ($_smarty_tpl->getVariable('Data')->value['mood_pic']!=''){?>
                            <a href="<?php echo $_smarty_tpl->getVariable('uploadUrl')->value;?>
<?php echo $_smarty_tpl->getVariable('Data')->value['mood_pic'];?>
" target="_blank">
...
" width="150" ></img>
                            ...
                            <?php }?>
                            <input type="file" name="mood_pic" id="mood_pic">
                            <?php if ($_smarty_tpl->getVariable('Data')->value['mood_pic']!=''){?>
                            <input type="checkbox" name="pic_Del" value="*" />刪除
                            <input type="hidden" name="opic" value="<?php echo $_smarty_tpl->getVariable('Data')->value['mood_pic'];?>
" />
                            <?php }?>
                          </div>
                          <div class="form-group">
...
" />
                          ...
                          <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="show_mode" id="show_mode1" value="Y" <?php if ($_smarty_tpl->getVariable('Data')->value['show_status']=="Y"||$_smarty_tpl->getVariable('Data')->value['mood_id']==''){?>checked<?php }?> >是
                            </label>
                            <label class="radio-inline">
        ...
        <input type="hidden" name="id" value="<?php echo $_smarty_tpl->getVariable('Data')->value['mood_id'];?>
" />
        </form>
    </div>
...
<script>
	...
	function FormCheck(){
		...
		if($("input[name='mood_date']").val()=="")
			errorMsg += "-請輸入發佈日期\n";
		
		if($("input[name='mood_title']").val()=="")
			errorMsg += "-請輸入標題\n";

<?php /* Smarty version Smarty3-RC3, created on 2014-05-04 21:18:20
         compiled from "C:/AppServ/www/kttline/admin/\templates\LinkList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3077853663e1c365d83-98438786%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '73129b61c50ac16c55f148d6bafaccf05c0f163c' => 
    array (
      0 => 'C:/AppServ/www/kttline/admin/\\templates\\LinkList.tpl',
      1 => 1399209486,
    ),
  ),
  'nocache_hash' => '3077853663e1c365d83-98438786',
  'function' => 
  array (
  ),
        	...
        	<div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                ...
                <div class="col-sm-12">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                        <label>
                        	查詢分類:
                            <select class="form-control" name="SearchClass" id="SearchClass">
...
" <?php if ($_smarty_tpl->getVariable('SearchClass')->value==$_smarty_tpl->tpl_vars['key']->value){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
</option>
                                <?php }} ?>
                            </select>
                        </label>
...
?>
                                <tr>
                                    <td><input type="checkbox" name="ids[]" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value['link_id'];?>
" /></td>
                                    <!--<td>
                                    	<?php echo $_smarty_tpl->getVariable('Class')->value[$_smarty_tpl->tpl_vars['obj']->value['link_class_id']];?>

                                    </td>-->
                                    <td>
                                    	<?php echo $_smarty_tpl->tpl_vars['obj']->value['link_title'];?>
...
?flag=edit&id=<?php echo $_smarty_tpl->tpl_vars['obj']->value['link_id'];?>
...
?flag=delete&ids=<?php echo $_smarty_tpl->tpl_vars['obj']->value['link_id'];?>

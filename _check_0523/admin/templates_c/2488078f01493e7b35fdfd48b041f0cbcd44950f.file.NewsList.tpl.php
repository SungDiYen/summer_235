<?php /* Smarty version Smarty3-RC3, created on 2014-11-04 17:00:28
         compiled from "/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin//templates/NewsList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1895817161545895ac65b9a3-43550788%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2488078f01493e7b35fdfd48b041f0cbcd44950f' => 
    array (
      0 => '/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin//templates/NewsList.tpl',
      1 => 1415091623,
    ),
  ),
  'nocache_hash' => '1895817161545895ac65b9a3-43550788',
  'function' => 
  array (
  ),
        	...
        	<div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                ...
                <div class="col-sm-12">
                    <div id="dataTables-example_filter" class="dataTables_filter" style="margin-bottom:10px">
                        ...
                        <select name="SearchTStatus" class="form-control input-sm" >
                            <option value="">是否顯示活動花絮</option>
                            <option value="Y" <?php if ($_smarty_tpl->getVariable('SearchTStatus')->value=="Y"){?>selected<?php }?>>是</option>
                            <option value="N" <?php if ($_smarty_tpl->getVariable('SearchTStatus')->value=="N"){?>selected<?php }?>>否</option>
                        </select>  
                        <?php }?>
                	...
                	<div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                            <tr>
                                <th width="60px"></th>
                                <th>標題</th>
                                <th width="100px">發佈日期 <a class="fa <?php if ($_smarty_tpl->getVariable('sortby')->value=='date'){?>fa-sort-<?php echo $_smarty_tpl->getVariable('sorticon')->value;?>
<?php }else{ ?>fa-sort<?php }?>" href="<?php echo $_smarty_tpl->getVariable('_FileName')->value;?>
?flag=sort&sortby=date"></a></th>

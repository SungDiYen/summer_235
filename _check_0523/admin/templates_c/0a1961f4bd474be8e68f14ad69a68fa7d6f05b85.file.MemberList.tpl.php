<?php /* Smarty version Smarty3-RC3, created on 2014-11-10 14:35:59
         compiled from "/var/www/vhosts/twkoikeya.com.tw/httpdocs/admin//templates/MemberList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:211869622854605ccf3e3042-15811524%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0a1961f4bd474be8e68f14ad69a68fa7d6f05b85' => 
    array (
      0 => '/var/www/vhosts/twkoikeya.com.tw/httpdocs/admin//templates/MemberList.tpl',
      1 => 1415601294,
    ),
  ),
  'nocache_hash' => '211869622854605ccf3e3042-15811524',
  'function' => 
  array (
  ),
...
" <?php if ($_smarty_tpl->getVariable('SearchBDay')->value==$_smarty_tpl->tpl_vars['foo']->value){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['foo']->value;?>
                        ...
                        <select name="SearchEpaper" class="form-control input-sm">
                        	<option value="">訂閱電子報</option>
                            <option value="Y" <?php if ($_smarty_tpl->getVariable('SearchEpaper')->value=="Y"){?>selected<?php }?>>Y</option>
                            <option value="N" <?php if ($_smarty_tpl->getVariable('SearchEpaper')->value=="N"){?>selected<?php }?>>N</option>
                        </select>
...
" /></td>
                                  ...
                                  <td><?php echo $_smarty_tpl->tpl_vars['obj']->value['member_mobile'];?>
</td>
                                  <td><?php echo $_smarty_tpl->tpl_vars['obj']->value['member_epaper'];?>
</td>

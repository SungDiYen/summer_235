<?php /* Smarty version Smarty3-RC3, created on 2014-05-10 22:41:00
         compiled from "C:/AppServ/www/kttline/admin/\templates\MediaEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12366536e3a7c3330e1-28299422%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fc6e546ee612ec9cac2a3a83c7b4069fd47fc1b5' => 
    array (
      0 => 'C:/AppServ/www/kttline/admin/\\templates\\MediaEdit.tpl',
      1 => 1399732847,
    ),
  ),
  'nocache_hash' => '12366536e3a7c3330e1-28299422',
  'function' => 
  array (
  ),
...
" class="form-control"/>
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="target" id="target">
                	<option value="_self" <?php if ($_smarty_tpl->getVariable('Data')->value['media_target']=="_self"){?>selected<?php }?>>本頁開啟</option>
                    <option value="_blank" <?php if ($_smarty_tpl->getVariable('Data')->value['media_target']=="_blank"){?>selected<?php }?>>另開視窗</option>
                </select>
              </div>

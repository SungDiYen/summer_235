<?php /* Smarty version Smarty3-RC3, created on 2015-04-19 16:22:51
         compiled from "C:/xampp/htdocs/blissfullybali/admin/\templates\ResortList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13074553365db3c36c8-22884336%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3eddeb0b789a94dab08c88512778a372fc5f57d9' => 
    array (
      0 => 'C:/xampp/htdocs/blissfullybali/admin/\\templates\\ResortList.tpl',
      1 => 1429431768,
    ),
  ),
  'nocache_hash' => '13074553365db3c36c8-22884336',
  'function' => 
  array (
  ),
                	...
                	<div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                            <tr>
                                <th width="60px"></th>
                                <th>名稱</th>
                                <th width="150px">酒店區域</th>
                                <th width="150px">適合對象</th>
                                <th width="120px">Kids Club</th>
...
?>
                            <tr>
                                <td><input type="checkbox" name="ids[]" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value['resort_id'];?>
" /></td>
                                <td>
                                    <?php echo $_smarty_tpl->tpl_vars['obj']->value['resort_name'];?>

                                </td>
                                <td><?php echo $_smarty_tpl->tpl_vars['obj']->value['resort_location'];?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['obj']->value['resort_applicable'];?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['obj']->value['resort_kidclub'];?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['obj']->value['show_status'];?>
</td>
                                <td>
                                    <a href="<?php echo $_smarty_tpl->getVariable('_FileName')->value;?>
?flag=edit&id=<?php echo $_smarty_tpl->tpl_vars['obj']->value['resort_id'];?>
...
?flag=delete&ids=<?php echo $_smarty_tpl->tpl_vars['obj']->value['resort_id'];?>

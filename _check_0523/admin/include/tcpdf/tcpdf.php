...
class TCPDF {
	 ...
	 * @since 2.0.000 (2008-01-02)
	 * @author Nicola Asuni
	 * ­ì¨Óªº $permissions=array('print', 'modify', 'copy', 'annot-forms', 'fill-forms', 'extract', 'assemble', 'print-high')
	 */
	public function SetProtection($permissions, $user_pass='', $owner_pass=null, $mode=0, $pubkeys=null) {
